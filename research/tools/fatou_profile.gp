...
loop(kc,nlim,nskip,looplim) = {
  ...
  while ((re<looplim) && (n<nlim) && (nskip>=0) && ((re>relast) || (nskip>0)),
    ...
    print("PROF ", n, " re=", re, " dps=", default(realprecision), " cts=", ctsamples, " tth=", proftth, " tst=", proftst, " trn=", proftrn, " st=", stopterms, " tsmp=", profsmp, " text=", profext);
    if (quietmode==0,
/*    printf("%4d =loopcnt %5.1f decimal digits, %4d ctsamples,%4d %4d thsamples\n", n, re, ctsamples, stopterms, thsamples);*/
  ...
  rslog=renormslog(ct);
  print("PROF final renormslog ms=", gettime());
